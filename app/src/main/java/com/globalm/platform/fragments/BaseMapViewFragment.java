...
public abstract class BaseMapViewFragment extends BaseFragment implements PermissionsListener,
        OnMapReadyCallback {
    //TODO Don't forget to call mapView.onCreate(savedInstanceState); in on create view
    ...
    public void onPermissionResult(boolean granted) {
        if (granted) {
            ...
            Toast.makeText(getContext(), "Permissons not granted", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        BaseMapViewFragment.this.mapboxMap = mapboxMap;
        onMapReadyCallback();
    }
